<html>
    ...
    <body>
        ...
        <div id="page">
            ...
            <article>
                <div id="block-menu-menu-autres-sites" role="navigation">
            ...
            <footer id="footer">
                <p>Quapropter a natura mihi videtur potius quam ab indigentia orta amicitia, applicatione magis animi cum quodam sensu amandi quam cogitatione quantum illa res utilitatis esset habitura. </p>
            </footer>
        </div>
    </body>
</html>